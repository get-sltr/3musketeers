...
export const LazyBlazeAI = lazy(() => import('./BlazeAI'))
...
export const LazyBlazeMatchFinder = lazy(() => import('./BlazeMatchFinder'))
export const LazyBlazeProfileOptimizer = lazy(() => import('./BlazeProfileOptimizer'))
