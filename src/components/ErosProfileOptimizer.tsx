...
interface ErosProfileOptimizerProps {
  currentProfile: any
  onOptimize: (suggestions: string[]) => void
}

export default function ErosProfileOptimizer({ currentProfile, onOptimize }: ErosProfileOptimizerProps) {
  ...
  return (
    <div className="glass-bubble p-6 rounded-2xl">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h3 className="text-white text-xl font-bold">EROS Profile Optimizer</h3>
          <p className="text-white/60 text-sm">Powered by Perplexity</p>
        </div>
      </div>
      
      <p className="text-white/80 mb-4">
        Let EROS analyze your profile and suggest improvements to help you make better connections!
      </p>
      ...
      {suggestions.length > 0 && (
        <div className="mt-6 space-y-3">
          <h4 className="text-white font-semibold">EROS Suggestions:</h4>
