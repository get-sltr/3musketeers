...
description: Senior Backend Engineer for API design, server-side development, and distributed systems. Use for API routes, business logic, security implementation, and performance optimization. Part of SIXTH phase in development pipeline.
