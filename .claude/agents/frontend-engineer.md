...
description: Senior Frontend Engineer for React, Next.js, TypeScript, and modern web development. Use for UI components, pages, state management, performance optimization, and accessibility. SIXTH phase in development pipeline.
